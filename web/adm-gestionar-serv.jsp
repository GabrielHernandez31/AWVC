...
<%
    ...
    */
    ...
    switch(accion){
        case "eliminar":
            out.print("<script>cancelar=confirm('Se eliminará: "+nombre+" con ubicación en: "+ubicacion+" ¿Deseas continuar?'); if(cancelar){ window.location.href='adm-eliminar-serv.jsp?id_servicio="+id_servicio+"'; }else{ window.location.href='adm-gestionar-serv.jsp'; }</script>");
        break;
        case "modificar":
            HttpSession sesion_act = request.getSession();
            sesion_act.setAttribute("id_servicio", id_servicio);
            response.sendRedirect("adm-modificar-serv.jsp");
        break;
        default:
                ...
                <div class="container col-md-12 col-lg-10" style="margin-top: 10px">
                    <div class="row  bg-info justify-content-center">
                        <div class="col-12 col-md-8" style="padding-top: 1vh;padding-bottom: 1vh">
                            <h1 class="text-withe">Gestionar Servicios</h1>
                        </div>
                        <div class="col-12 col-md-4 text-center" style="padding-top: 1vh;padding-bottom: 1vh">
                            <a href="adm-registrar-serv.jsp" class="btn btn-success"><i class="fas fa-plus-circle"></i> Agregar </a>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center align-content-center" >
                        <div class="col-12-block table-responsive"  style="padding-top: 1vh;padding-bottom: 1vh; font-size: 2.5vh">
                            <table class="table text-center">
                                ...
                                <tbody>
                                    <%  
                                    if(servicio.existenServiciosAdm()){
                                        String[][] servicios = servicio.consultarServiciosAdm();
                                        
                                        for( int cuenta = 0; cuenta<servicio.contarServiciosAdm(); cuenta++){
                                    %>  
                                    <tr>
                                        ...
                                        <td><% out.print(usuario.obtenerNombreUsuario(servicios[cuenta][6])); %></td>
                                        <td class="text-center"><a href="adm-gestionar-serv.jsp?accion=modificar&id_servicio=<% out.print(servicios[cuenta][0]); %>" class="text-primary">
                                        ...
                                        <td class="text-center"><a href="adm-gestionar-serv.jsp?accion=eliminar&id_servicio=<% out.print(servicios[cuenta][0]); %>&nombre=<% out.print(servicios[cuenta][1]); %>&ubicacion=<% out.print(servicios[cuenta][3]); %>" class="text-danger">
