...
<html lang="es">
    <head>
        ...
        <title>Gestionar Automoviles</title>
    </head>
    <body>
                ...
                <div class="container col-md-12 col-lg-10">
                    <div class="row col-12">
                        <div class="col-xl-12 text-center">
                            <h1 class="text-dark">Gestionar Automóviles</h1>
                        </div>
                    </div>
                    ...
                    <div class="row  bg-info justify-content-center">
                        ...
                        <div class="col-12 col-md-4 text-center" style="padding-top: 1vh;padding-bottom: 1vh">
                            <a href="adm-registrar-auto.jsp" class="btn btn-success"><i class="fas fa-plus-circle"></i> Agregar </a>
                        </div>
                    </div>
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td class="text-center"><a href="adm-modificar-auto.jsp" class="text-primary">
                                    ...
                                    <tr>
                                        <th colspan="9" style="text-align: center;">No existen autos aún.</th>
                                    </tr>
